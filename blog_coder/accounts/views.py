...
def register_request(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(request, 'blog/home.html', {"title": "Home", "message": "Intente nuevamente, la contraseña debe tener al menos 8 caracteres", "errors": ["No pasó las validaciones"]})
...
def login_request(request):
    ...
    if  request.method == "POST":
        ...
        if form.is_valid():
            ...
            if user is not None:
                login(request, user)
                return render(request, 'blog/home.html', {"title": "Home", "message": f"¡Bienvenido {user}!"})
            else:
